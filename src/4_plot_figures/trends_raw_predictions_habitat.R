...
# Plot objects used for Figure 2b (Trend maps)
...
cp <- cowplot::plot_grid(p_means.1960$Forest,p_means.1960$Grassland,p_means.1960$Scrub, p_means.1960$Wetland)
cp
...
ggsave("./fig/generaltrend_stdpltsz/minitrends.changeto1960.pdf", cp, width = 5*0.77, height = 4.5*0.77)
ggsave("./fig/generaltrend_stdpltsz/minitrends.changeto1960.png", cp, width = 5*0.77, height = 4.5*0.77)
